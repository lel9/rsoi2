package ru.bmstu.testsystem.users
...
import ru.bmstu.testsystem.users.model.RequestOut
import ru.bmstu.testsystem.users.web.util.RestPageImpl
import java.net.URI
...
class TestingSystemApplication {
    ...
    private val host: String = "user-service"
